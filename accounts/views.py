...
def register_page(request):
    ...
    if request.method == 'POST':
        ...
        # -----------------------------------------------------------------
        # temporary change
        # send_account_activation_email.delay(email, email_token)   --uncomment later
        activate_email(request, email_token)      #directly activate account without verification
